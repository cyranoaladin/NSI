...
\textbf{Trace} : milieu $= 2 \rightarrow$ tab[2]$=18 < 37$, gauche$=3$. Milieu $= 4 \rightarrow$ tab[4]$=37$. Trouvé.\\
\textbf{Résultat} : milieux $18$ puis $37$ $\rightarrow$ cible trouvée à l'indice $4$.\\
...
\textbf{Cas limite} : pièce $1$ absente $\rightarrow$ le glouton peut échouer (ex.\ montant~$3$ avec \texttt{[5,2]}).
