...
- Donnée utilisée alpha dans T10 TD sql select where join : cas alpha de l exercice 1 avec les valeurs indiquées dans l énoncé.
- Méthode alpha dans T10 TD sql select where join : trace courte, pseudo-code local `if cas_alpha: décider else: calculer`, invariant nommé et complexité `O(n)`.
- Résultat alpha dans T10 TD sql select where join : sortie vérifiable de l exercice 1, reliée à la capacité officielle du bloc.
- Contrôle alpha dans T10 TD sql select where join : le cas limite annoncé est décidé explicitement et une réponse sans trace est refusée.
### Corrigé exercice 2
...
- Donnée utilisée beta dans T10 TD sql select where join : cas beta de l exercice 2 avec les valeurs indiquées dans l énoncé.
- Méthode beta dans T10 TD sql select where join : trace courte, pseudo-code local `if cas_beta: décider else: calculer`, invariant nommé et complexité `O(n)`.
- Résultat beta dans T10 TD sql select where join : sortie vérifiable de l exercice 2, reliée à la capacité officielle du bloc.
- Contrôle beta dans T10 TD sql select where join : le cas limite annoncé est décidé explicitement et une réponse sans trace est refusée.
### Corrigé exercice 3
...
- Donnée utilisée gamma dans T10 TD sql select where join : cas gamma de l exercice 3 avec les valeurs indiquées dans l énoncé.
- Méthode gamma dans T10 TD sql select where join : trace courte, pseudo-code local `if cas_gamma: décider else: calculer`, invariant nommé et complexité `O(n)`.
- Résultat gamma dans T10 TD sql select where join : sortie vérifiable de l exercice 3, reliée à la capacité officielle du bloc.
- Contrôle gamma dans T10 TD sql select where join : le cas limite annoncé est décidé explicitement et une réponse sans trace est refusée.
### Corrigé exercice 4
...
- Donnée utilisée delta dans T10 TD sql select where join : cas delta de l exercice 4 avec les valeurs indiquées dans l énoncé.
- Méthode delta dans T10 TD sql select where join : trace courte, pseudo-code local `if cas_delta: décider else: calculer`, invariant nommé et complexité `O(n)`.
- Résultat delta dans T10 TD sql select where join : sortie vérifiable de l exercice 4, reliée à la capacité officielle du bloc.
- Contrôle delta dans T10 TD sql select where join : le cas limite annoncé est décidé explicitement et une réponse sans trace est refusée.
### Corrigé exercice 5
...
- Donnée utilisée epsilon dans T10 TD sql select where join : cas epsilon de l exercice 5 avec les valeurs indiquées dans l énoncé.
- Méthode epsilon dans T10 TD sql select where join : trace courte, pseudo-code local `if cas_epsilon: décider else: calculer`, invariant nommé et complexité `O(n)`.
...
- Méthode zeta dans T10 TD sql select where join : trace courte, pseudo-code local `if cas_zeta: décider else: calculer`, invariant nommé et complexité `O(n)`.
- Résultat zeta dans T10 TD sql select where join : sortie vérifiable de l exercice 6, reliée à la capacité officielle du bloc.
- Contrôle zeta dans T10 TD sql select where join : le cas limite annoncé est décidé explicitement et une réponse sans trace est refusée.
### Corrigé exercice 7
...
- Donnée utilisée eta dans T10 TD sql select where join : cas eta de l exercice 7 avec les valeurs indiquées dans l énoncé.
- Méthode eta dans T10 TD sql select where join : trace courte, pseudo-code local `if cas_eta: décider else: calculer`, invariant nommé et complexité `O(n)`.
- Résultat eta dans T10 TD sql select where join : sortie vérifiable de l exercice 7, reliée à la capacité officielle du bloc.
- Contrôle eta dans T10 TD sql select where join : le cas limite annoncé est décidé explicitement et une réponse sans trace est refusée.
### Corrigé exercice 8
...
- Donnée utilisée theta dans T10 TD sql select where join : cas theta de l exercice 8 avec les valeurs indiquées dans l énoncé.
- Méthode theta dans T10 TD sql select where join : trace courte, pseudo-code local `if cas_theta: décider else: calculer`, invariant nommé et complexité `O(n)`.
- Résultat theta dans T10 TD sql select where join : sortie vérifiable de l exercice 8, reliée à la capacité officielle du bloc.
- Contrôle theta dans T10 TD sql select where join : le cas limite annoncé est décidé explicitement et une réponse sans trace est refusée.
