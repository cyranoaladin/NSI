...
notion: "Aides graduées pour SELECT, JOIN, UPDATE et DELETE"
private_data: false
official_program:
  capacities:
    - "T-BDD-03A"
...
Pour filtrer une lecture, ajouter `WHERE`. Pour utiliser deux tables, ajouter `JOIN ... ON`.

## Tâche 1 — Lecture avec jointure

**Consigne.** Afficher le nom et la note des élèves ayant au moins 15 en NSI.
