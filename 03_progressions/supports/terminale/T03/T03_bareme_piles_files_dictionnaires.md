...
# T03 - Bareme - Piles, files et dictionnaires
...
- Exemple support : `empiler A, empiler B, dépiler`.
- Résultat support : `B sort avant A pour une pile ; A sort avant B pour une file`.
...
- Corrigé question 1 : méthode choisir LIFO ou FIFO selon l’ordre de sortie attendu, résultat `B sort avant A pour une pile ; A sort avant B pour une file`, contrôle EF1.
- Corrigé question 2 : méthode choisir LIFO ou FIFO selon l’ordre de sortie attendu, résultat `B sort avant A pour une pile ; A sort avant B pour une file`, contrôle EF2.
- Corrigé question 3 : méthode choisir LIFO ou FIFO selon l’ordre de sortie attendu, résultat `B sort avant A pour une pile ; A sort avant B pour une file`, contrôle EF3.
- Corrigé question 4 : méthode choisir LIFO ou FIFO selon l’ordre de sortie attendu, résultat `B sort avant A pour une pile ; A sort avant B pour une file`, contrôle EF4.
