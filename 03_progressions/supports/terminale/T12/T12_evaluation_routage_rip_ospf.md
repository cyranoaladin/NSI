...
## Questions
### Question 1 - Lire une table de routage locale et repérer le prochain saut
- Capacité : T-ARCH-03.
- Données : Liens : R1-R2 coût 1, R2-R4 coût 5, R1-R3 coût 2, R3-R4 coût 2, R2-R3 coût 1 ; destination réseau D derrière R4.
- Consigne : répondre à la tâche « lire une table de routage locale et repérer le prochain saut » avec méthode, résultat et contrôle.
- Format attendu : réponse courte mais justifiée, avec notation ou pseudo-code si nécessaire.
### Question 2 - Analyser une annonce rip en nombre de sauts
- Capacité : T-ARCH-03.
- Données : Liens : R1-R2 coût 1, R2-R4 coût 5, R1-R3 coût 2, R3-R4 coût 2, R2-R3 coût 1 ; destination réseau D derrière R4.
- Consigne : répondre à la tâche « analyser une annonce RIP en nombre de sauts » avec méthode, résultat et contrôle.
- Format attendu : réponse courte mais justifiée, avec notation ou pseudo-code si nécessaire.
### Question 3 - Produire le meilleur chemin par coût total
- Capacité : T-ARCH-03.
- Données : Liens : R1-R2 coût 1, R2-R4 coût 5, R1-R3 coût 2, R3-R4 coût 2, R2-R3 coût 1 ; destination réseau D derrière R4.
- Consigne : répondre à la tâche « produire le meilleur chemin par coût total » avec méthode, résultat et contrôle.
- Format attendu : réponse courte mais justifiée, avec notation ou pseudo-code si nécessaire.
### Question 4 - Écrire une mise à jour de table après panne r2-r4
- Capacité : T-ARCH-03.
- Données : Liens : R1-R2 coût 1, R2-R4 coût 5, R1-R3 coût 2, R3-R4 coût 2, R2-R3 coût 1 ; destination réseau D derrière R4.
- Consigne : répondre à la tâche « écrire une mise à jour de table après panne R2-R4 » avec méthode, résultat et contrôle.
- Format attendu : réponse courte mais justifiée, avec notation ou pseudo-code si nécessaire.
...
- Réponse attendue : la solution explicite « lire une table de routage locale et repérer le prochain saut » à partir des données fournies.
...
### Corrigé question 2
- Capacité évaluée : T-ARCH-03.
- Réponse attendue : la solution explicite « analyser une annonce RIP en nombre de sauts » à partir des données fournies.
- Justification : les étapes doivent permettre de retrouver le résultat sans deviner.
- Point de vigilance : une conclusion isolée sans contrôle perd les points de méthode.
### Corrigé question 3
- Capacité évaluée : T-ARCH-03.
- Réponse attendue : la solution explicite « produire le meilleur chemin par coût total » à partir des données fournies.
- Justification : les étapes doivent permettre de retrouver le résultat sans deviner.
- Point de vigilance : une conclusion isolée sans contrôle perd les points de méthode.
### Corrigé question 4
- Capacité évaluée : T-ARCH-03.
- Réponse attendue : la solution explicite « écrire une mise à jour de table après panne R2-R4 » à partir des données fournies.
- Justification : les étapes doivent permettre de retrouver le résultat sans deviner.
- Point de vigilance : une conclusion isolée sans contrôle perd les points de méthode.
