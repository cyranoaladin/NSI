---
title: "T00 - Td - Diagnostic Terminale et tests"
level: "terminale"
sequence_id: "T00"
document_type: "td"
status: "needs_review"
...
# T00 - Td - Diagnostic Terminale et tests
...
- Méthode : isoler la fonction, écrire le contrat, tester cas nominal et cas limite.
...
- Énoncé : résoudre une variante de `fonction maximum([3, 8, 2])` en changeant une donnée contrôlée.
- Travail demandé : appliquer isoler la fonction, écrire le contrat, tester cas nominal et cas limite, puis rédiger le contrôle.
- Contrainte : citer le cas limite `liste vide ou mutation inattendue` si la méthode peut échouer.
...
## Corrigé
### Corrigé exercice 1
- On repère d’abord liste de valeurs et contrat de fonction.
- On applique ensuite isoler la fonction, écrire le contrat, tester cas nominal et cas limite.
- Le résultat attendu est `8 avec test nominal, test limite et test d’erreur` pour l’exemple de référence ou une valeur cohérente pour la variante.
