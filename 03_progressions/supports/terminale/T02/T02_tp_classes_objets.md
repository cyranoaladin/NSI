---
title: "T02 - Tp - Classes, objets et invariants"
level: "terminale"
sequence_id: "T02"
document_type: "tp"
status: "needs_review"
...
# T02 - Tp - Classes, objets et invariants
...
- Mission : écrire une classe courte avec invariant et tests unitaires.
- Starter code : `03_progressions/supports/terminale/T02/code/T02_starter_classes_objets.py`.
- Tests attendus : `03_progressions/supports/terminale/T02/code/T02_tests_attendus_classes_objets.py`.
- Corrigé professeur séparé : `03_progressions/supports/terminale/T02/code/T02_corrige_professeur_classes_objets.py`.
- Fonction principale à compléter ou contrôler : `creer_compte(solde)`.
- Exemple d’entrée : `20`.
- Exemple d’exécution : l’exemple de référence `Compte("Ada", 20).retirer(7)` conduit à `solde 13 si l’invariant reste vérifié`.
- Cas limite : montant négatif ou accès direct à l’attribut.
...
- On appelle `creer_compte(20)`.
- La fonction doit appliquer définir constructeur, attributs, méthodes et invariant vérifié après mutation.
- Le résultat contrôlé est `solde 13 si l’invariant reste vérifié` ou une structure portant cette information.
...
## Corrigé
- Corrigé exercice 1 : le test vérifie définir constructeur, attributs, méthodes et invariant vérifié après mutation et couvre EF1.
- Corrigé exercice 2 : le test vérifie définir constructeur, attributs, méthodes et invariant vérifié après mutation et couvre EF2.
- Corrigé exercice 3 : le test vérifie définir constructeur, attributs, méthodes et invariant vérifié après mutation et couvre EF3.
- Corrigé exercice 4 : le test vérifie définir constructeur, attributs, méthodes et invariant vérifié après mutation et couvre EF4.
- Corrigé exercice 5 : le test vérifie définir constructeur, attributs, méthodes et invariant vérifié après mutation et couvre EF1.
- Corrigé exercice 6 : le test vérifie définir constructeur, attributs, méthodes et invariant vérifié après mutation et couvre EF2.
- Corrigé exercice 7 : le test vérifie définir constructeur, attributs, méthodes et invariant vérifié après mutation et couvre EF3.
- Corrigé exercice 8 : le test vérifie définir constructeur, attributs, méthodes et invariant vérifié après mutation et couvre EF4.
