...
Allemagne,Berlin,Europe,82801531` donne une ligne exploitable.
...
- Exemple minimal : lignes regroupées par CONTINENT donne pays triés par CONTINENT puis POPULATION.
