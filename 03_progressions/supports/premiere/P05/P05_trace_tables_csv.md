...
- À retenir : séparer en-tête et données puis convertir la température.
- Exemple minimal : `ville,temp
Tunis,24` donne une ligne exploitable.
- Vigilance : contrôler « fichier vide ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 2 - filtrage
- À retenir : conserver les lignes respectant un prédicat.
- Exemple minimal : trois villes dont deux Tunis donne deux lignes sélectionnées.
- Vigilance : contrôler « aucune ligne retenue ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 3 - agrégation
- À retenir : ignorer ou signaler le champ vide avant moyenne.
- Exemple minimal : `24`, `26`, champ vide donne `25`.
- Vigilance : contrôler « division par zéro ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 4 - jointure simple
- À retenir : associer par une clé commune.
- Exemple minimal : table villes et table régions donne ville enrichie par région.
- Vigilance : contrôler « clé inconnue ».
- Question flash : que devient la méthode si la donnée change légèrement ?
## Exercices numérotés
