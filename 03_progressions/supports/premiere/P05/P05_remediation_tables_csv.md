...
- Diagnostic : refaire lecture CSV avec `ville,temp
Tunis,24` et repérer l’étape fautive.
- Activité corrective EF1 : Marquer l’en-tête et commencer les données à la ligne suivante.
- Nouvelle tâche : produire une réponse sur un cas voisin qui vérifie « fichier vide ».
...
- Diagnostic : refaire filtrage avec trois villes dont deux Tunis et repérer l’étape fautive.
- Activité corrective EF2 : Convertir explicitement avant les comparaisons numériques.
- Nouvelle tâche : produire une réponse sur un cas voisin qui vérifie « aucune ligne retenue ».
- Critère de sortie : l’élève explique la correction sans reprendre la phrase du cours.
### Remédiation EF3
- Erreur fréquente EF3 - Diviser par zéro après filtrage vide.
- Diagnostic : refaire agrégation avec `24`, `26`, champ vide et repérer l’étape fautive.
- Activité corrective EF3 : Tester la taille de la sélection avant la moyenne.
- Nouvelle tâche : produire une réponse sur un cas voisin qui vérifie « division par zéro ».
- Critère de sortie : l’élève explique la correction sans reprendre la phrase du cours.
### Remédiation EF4
- Erreur fréquente EF4 - Ignorer silencieusement une ligne mal formée.
- Diagnostic : refaire jointure simple avec table villes et table régions et repérer l’étape fautive.
- Activité corrective EF4 : Isoler les lignes invalides dans une liste de rejets.
- Nouvelle tâche : produire une réponse sur un cas voisin qui vérifie « clé inconnue ».
- Critère de sortie : l’élève explique la correction sans reprendre la phrase du cours.
## Exercices numérotés
