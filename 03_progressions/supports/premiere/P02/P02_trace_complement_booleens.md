...
# P02 - Trace - Complément à deux et booléens
...
- Notion : entiers signés, débordement, expressions booléennes.
- Exemple mémorisé : `-23 sur 8 bits et (a and b) or (a and not b)`.
- Résultat contrôlé : 11101001 et simplification en a.
- Méthode courte : inverser les bits, ajouter 1, puis vérifier les bornes de l’intervalle signé.
- Cas limite à écrire dans la marge : 140 impossible sur 8 bits signés.

## Exemple corrigé précis
- Donnée : mot binaire de 8 bits et deux variables booléennes.
- Calcul ou raisonnement : inverser les bits, ajouter 1, puis vérifier les bornes de l’intervalle signé.
- Conclusion : le résultat contrôlé est `11101001 et simplification en a`.
...
## Corrigé
- Corrigé exercice 1 : la trace contient donnée, opération, résultat `11101001 et simplification en a` et contrôle EF1.
- Corrigé exercice 2 : la trace contient donnée, opération, résultat `11101001 et simplification en a` et contrôle EF2.
- Corrigé exercice 3 : la trace contient donnée, opération, résultat `11101001 et simplification en a` et contrôle EF3.
- Corrigé exercice 4 : la trace contient donnée, opération, résultat `11101001 et simplification en a` et contrôle EF4.
- Corrigé exercice 5 : la trace contient donnée, opération, résultat `11101001 et simplification en a` et contrôle EF1.
- Corrigé exercice 6 : la trace contient donnée, opération, résultat `11101001 et simplification en a` et contrôle EF2.
- Corrigé exercice 7 : la trace contient donnée, opération, résultat `11101001 et simplification en a` et contrôle EF3.
- Corrigé exercice 8 : la trace contient donnée, opération, résultat `11101001 et simplification en a` et contrôle EF4.
