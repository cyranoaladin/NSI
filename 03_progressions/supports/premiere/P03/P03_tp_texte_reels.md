...
- Mission : inspecter les octets UTF-8 et tester une comparaison tolérante de flottants.
- Starter code : `03_progressions/supports/premiere/P03/code/P03_starter_texte_reels.py`.
- Tests attendus : `03_progressions/supports/premiere/P03/code/P03_tests_attendus_texte_reels.py`.
- Corrigé professeur séparé : `03_progressions/supports/premiere/P03/code/P03_corrige_professeur_texte_reels.py`.
- Fonction principale à compléter ou contrôler : `inspect_text(text)`.
- Exemple d’entrée : `"Aé"`.
- Exemple d’exécution : l’exemple de référence `Aé et 0.1 + 0.2` conduit à `2 caractères, 3 octets, somme flottante non exactement égale à 0.3`.
- Cas limite : caractère hors ASCII ou comparaison directe de flottants.
...
- On appelle `inspect_text("Aé")`.
- La fonction doit appliquer distinguer point de code, encodage, octets et approximation machine.
- Le résultat contrôlé est `2 caractères, 3 octets, somme flottante non exactement égale à 0.3` ou une structure portant cette information.
...
## Corrigé
- Corrigé exercice 1 : le test vérifie distinguer point de code, encodage, octets et approximation machine et couvre EF1.
- Corrigé exercice 2 : le test vérifie distinguer point de code, encodage, octets et approximation machine et couvre EF2.
- Corrigé exercice 3 : le test vérifie distinguer point de code, encodage, octets et approximation machine et couvre EF3.
- Corrigé exercice 4 : le test vérifie distinguer point de code, encodage, octets et approximation machine et couvre EF4.
- Corrigé exercice 5 : le test vérifie distinguer point de code, encodage, octets et approximation machine et couvre EF1.
- Corrigé exercice 6 : le test vérifie distinguer point de code, encodage, octets et approximation machine et couvre EF2.
- Corrigé exercice 7 : le test vérifie distinguer point de code, encodage, octets et approximation machine et couvre EF3.
- Corrigé exercice 8 : le test vérifie distinguer point de code, encodage, octets et approximation machine et couvre EF4.
